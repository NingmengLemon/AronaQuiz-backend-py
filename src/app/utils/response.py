...
class ResponseUtil:
    ...
    @staticmethod
    def bad_request(message: str = "请求参数错误", data: Any = None) -> ApiResponse[Any]:
        """创建400错误响应"""
    ...
    @staticmethod
    def validation_error(message: str = "数据验证失败", data: Any = None) -> ApiResponse[Any]:
        """创建422验证错误响应"""
        return ApiResponse.error(
    ...
    @staticmethod
    def internal_error(message: str = "服务器内部错误", data: Any = None) -> ApiResponse[Any]:
        """创建500错误响应"""
        return ApiResponse.error(
